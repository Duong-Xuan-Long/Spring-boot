...
public class CategoryController {
    ...
    public String getCategoryPage(@PathVariable("pageNo") int pageNo, Model model, Principal principal) {
        ...
        Page<Category> categories = categoryService.pageCategories(pageNo);
    ...
    @GetMapping("/search-categories/{pageNo}")
    public String searchProducts(@PathVariable("pageNo") int pageNo,
        ...
        Page<Category> categories = categoryService.searchCategories(pageNo, keyword);
        model.addAttribute("categories", categories);
        model.addAttribute("size", categories.getSize());
        model.addAttribute("currentPage", pageNo);
        model.addAttribute("totalPages", categories.getTotalPages());
