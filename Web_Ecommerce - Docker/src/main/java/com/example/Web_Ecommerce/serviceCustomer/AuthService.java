package com.example.Web_Ecommerce.serviceCustomer;


import com.example.Web_Ecommerce.configCustomer.CustomerDetails;
import com.example.Web_Ecommerce.configCustomer.CustomerServiceConfig;
import com.example.Web_Ecommerce.configCustomer.JwtUtils;
import com.example.Web_Ecommerce.exception.BadRequestException;
import com.example.Web_Ecommerce.exception.NotFoundException;
import com.example.Web_Ecommerce.model.Customer;
import com.example.Web_Ecommerce.model.Token;
import com.example.Web_Ecommerce.repository.CustomerRepository;
import com.example.Web_Ecommerce.repository.TokenRepository;
...
import static com.example.Web_Ecommerce.constant.Constant.MAX_AGE_COOKIE;
...
//    private AuthenticationManager authenticationManager;
    ...
    @Autowired
    private CustomerEmailService mailService;
...
//        httpServletResponse.addCookie(cookie1);
    ...
    public String register(RegisterRequest request) throws MessagingException {
        ...
        Customer newCustomer = new Customer(request.getFirstName(), request.getLastName(),
                request.getEmail(), passwordEncode, List.of("CUSTOMER"));
    ...
    public String confirmToken(String tokenString) {
        ...
        return "Tài khoản đã được xác nhận bạn hãy quay lại trang đăng nhập";
    }
}
