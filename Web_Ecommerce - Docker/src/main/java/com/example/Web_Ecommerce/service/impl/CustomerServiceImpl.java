package com.example.Web_Ecommerce.service.impl;
...
import com.example.Web_Ecommerce.utils.ImageUploadCustomer;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerDto save(CustomerDto customerDto) {
        ...
        customer.setRoles(Arrays.asList("CUSTOMER"));
    ...
    public void giveAdminRole(Long id) {
        Customer customer=customerRepository.findById(id).get();
        customer.setRoles(List.of("ADMIN","CUSTOMER"));
        customerRepository.save(customer);
    }
    //Bỏ cấp quyên admin
    @Override
    public void takeAdminRole(Long id) {
        Customer customer=customerRepository.findById(id).get();
